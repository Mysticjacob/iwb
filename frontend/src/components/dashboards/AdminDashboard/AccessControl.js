...
const ProductManager = () => {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get("https://iwb-2213.vercel.app/api/products");
  ...
  const handleAddProduct = async () => {
    try {
      await axios.post("https://iwb-2213.vercel.app/api/products", {
        ...newProduct,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://iwb-2213.vercel.app/api/products/${id}`);
      fetchProducts();
    } catch (err) {
