...
const DeploymentControls = () => {
  const handleDeploy = async () => {
    try {
      await axios.post("https://iwb-2213.vercel.app/api/developer/deploy");
  ...
  const handleRestart = async () => {
    try {
      await axios.post("https://iwb-2213.vercel.app/api/developer/restart");
  ...
  const handleRollback = async () => {
    try {
      await axios.post("https://iwb-2213.vercel.app/api/developer/rollback");
